...
const ShowSubjects = () => {
  ...
  const { subjectsList, loading, response } = useSelector(
    (state) => state.sclass
  );
  ...
  // Pagination range generator (max 5 page buttons)
  ...
  // Actions menu component for each row
  ...
  // Buttons and menu for each subject row
  ...
  // Top actions like add new or delete all
      ...
      <div className="bg-white mx-auto max-w-7xl p-8 rounded-lg shadow-md">
        ...
        {loading ? (
          ...
          <div className="flex justify-end mb-6">
            <GreenButton
              className="!text-sm !px-5 !py-2 rounded-md shadow-md hover:shadow-lg transition-shadow"
